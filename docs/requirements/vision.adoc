...
| Barbetreiber
| Besitzer der Bar
| Gibt den Auftrag vor
 
| Kunden
| Kunden der Bar
| Hauptnutzer der Software. Bestellen ihre Cocktails damit. Können eigene Cocktails zusammenstellen.
 
| Zahlungsabwicklung
| Zahlungsservice wie zb Paypal
| Kümmert sich darum, dass die Kunden ihre Bestellungen bezahlen und die Bar das Geld bekommt.

| Gesetzgeber
| Jugendschutz, Datenschutz
| Mindestbestellalter bzw. Alterskontrolle bei akoholhaltigen Cocktails. Datenschutz.

| Lieferung
| Mitarbeiter der Bar bzw. externes Lieferunternehmen/Spetition
| Liefern die Cocktails zum Kunden aus.

| Mitarbeiter
| Mitarbeiter der Bar
| Stellen die Cocktails zusammen.

| Host
| Host, auf welchem die Software/Internetseite läuft
| Stellt Service zu verfügung, dass die Website überhaupt online ist.
